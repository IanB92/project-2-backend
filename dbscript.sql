...
ALTER TABLE reimbursement_details add column image varchar(100);
...
ALTER TABLE pending_details add column image varchar(100);
...
INSERT INTO employee_details(first_name, last_name, address, contact, email, username, password) VALUES('percy', 'jackson', 'camp half blood', '7058757777', 'sonOfposiedon@gmail.com', '11', '02');
